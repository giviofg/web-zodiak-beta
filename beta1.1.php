  ...
  <body>
   <form method="POST">
    ...
    <table style="color:black"  align="center" border="5" width="450">
     <tr>
      <th><center>Aplikasi Zodiak</center></th>
     </tr>
     <tr>
...
$Lambangzodiak=$_POST['Lambang'];
    ...
    if (($tanggal>=21 && $tanggal<=31 && $blnzodiak=="maret")||($tanggal<=19 && $blnzodiak=="april")){
     $zodiak= "Aries";
     $LambangZodiak= "<img src=\"lambang_Aries.jpg\"\"width=\"450\"height=\"300\">";
...
<h3>Warna Keberuntungan :</h3> Putih.<br>

<h3>Zodiak :</h3> Eunhyuk, Siwon & Zhoumi. ";
    }else if(($tanggal>=20 && $tanggal<=30 && $blnzodiak=="april" )||($tanggal<=20 && $blnzodiak=="mei")){
     $zodiak = "Taurus";
     $LambangZodiak= "<br><img src=\"lambang_TAURUS.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\">";
...
<h3>Warna Keberuntungan :</h3> Abu-abu.";
     ...
     $zodiak = "Gemini";
     $LambangZodiak= "<img src=\"lambang_Gemini.jpg\" \alt=\"Smiley face\ \"width=\"450\"height=\"300\">";
...
";
     ...
     $zodiak = "Kanser";
     $LambangZodiak= "<img src=\"lambang_CANCER.jpg\" \alt=\"Smiley face\ \"width=\"450\"height=\"300\">";
...
<h3>Zodiak :</h3> Teuki, Heechul & Ryeowook.
";
    }else if(($tanggal>=23 && $tanggal<=31 && $blnzodiak=="juli")||($tanggal<=22 && $blnzodiak=="agustus")){
     $zodiak = "Leo";
     $LambangZodiak= "<img src=\"lambang_leo.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\" >";
...
";
     ...
     $zodiak = "Virgo";
     $LambangZodiak= "<img src=\"lambang_virgo.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\" >";
...
<h3>Zodiak :</h3> KiBum & Yesung.";
    }else if(($tanggal>=23 && $tanggal<=30 && $blnzodiak=="september")||($tanggal<=22 && $blnzodiak=="oktober")){
     $zodiak = "Libra";
     $LambangZodiak= "<img src=\"lambang_libra.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\" >";
...
<h3>Zodiak :</h3> ShinDong, Donghae & Henry.
";
    }else if(($tanggal>=23 && $tanggal<=31 && $blnzodiak=="oktober")||($tanggal<=21 && $blnzodiak=="november")){
     $zodiak = "Skorpio";
     $LambangZodiak= "<img src=\"lambang_Scorpio.jpg\" \alt=\"Smiley face\ \"width=\"450\"height=\"300\">";
...
<h3>Warna Keberuntungan :</h3> Hitam.";
     ...
     $zodiak = "Sagitarius";
     $LambangZodiak= "<img src=\"lambang_sagitarius.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\" >";
...
<h3>Warna Keberuntungan : </h3>Hijau Muda.";
     ...
     $zodiak = "Kaprikornus";
     $LambangZodiak= "<img src=\"lambang_capricorn.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\" >";
...
<h3>Zodiak  :</h3> Sungmin & Kangin.";
    }else if(($tanggal>=20 && $tanggal<=31 && $blnzodiak=="januari")||($tanggal<=18 && $blnzodiak=="februari")){
     $zodiak = "Akuarius";
     $LambangZodiak= "<img src=\"lambang_Aquarius.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\" >";
...
<h3>Zodiak :</h3> Kyuhyun & Hangeng.";
    }else if(($tanggal>=19 && $tanggal<=29 && $blnzodiak=="februari")||($tanggal<=20 && $blnzodiak=="maret")){
     $zodiak = "Pises";
     $LambangZodiak= "<img src=\"lambang_pisces.jpg\"\alt=\"Smiley face\ \"width=\"450\"height=\"300\" >";
